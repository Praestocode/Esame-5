...
class CampiObbligatori {
    static verificaCampiObbligatori(dati: Contatto): [boolean, boolean]  {
    ...
    static nascondiMessaggiErrore(): void {
    ...
    static mostraMessaggioErrore(id: string): void {
    ...
    static nascondiMessaggioErrore(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
...
// Gestione messaggi altri casi
    ...
    static nascondiMessaggiErrore2(): void {
        const warningElements = document.querySelectorAll('.warning');
        warningElements.forEach((element: HTMLElement) => {
            element.style.display = 'none';
        });
    ...
    static mostraMessaggioErrore2(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
    ...
    static nascondiMessaggioErrore2(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
            warningElement.style.display = 'none';
        }
...
// Gestione messaggi errore Password 1
    ...
    static nascondiMessaggiErrorePsw(): void {
        const warningElements = document.querySelectorAll('.warning');
        warningElements.forEach((element: HTMLElement) => {
            element.style.display = 'none';
        });
    ...
    static mostraMessaggioErrorePsw(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
            warningElement.innerHTML = `
    ...
    static nascondiMessaggioErrorePsw(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
            warningElement.style.display = 'none';
        }
    ...
    static nascondiMessaggiErrorePsw2(): void {
        const warningElements = document.querySelectorAll('.warning');
        warningElements.forEach((element: HTMLElement) => {
            element.style.display = 'none';
        });
    ...
    static mostraMessaggioErrorePsw2(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
            warningElement.innerHTML = `
    ...
    static nascondiMessaggioErrorePsw2(id: string): void {
        const warningElement = document.getElementById(id);
        if (warningElement) {
            warningElement.style.display = 'none';
        }
...
class Registrazione {
    static registra(newData: Contatto): Promise<void> {
